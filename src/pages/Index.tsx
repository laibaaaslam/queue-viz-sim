...
const Index = () => {
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-slate-50 to-blue-50">
      <header className="w-full py-8 px-6 md:px-12 lg:px-20">
      ...
      <main className="flex-grow flex flex-col items-center justify-center px-4 py-8">
        <div className="w-full max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <Card className="shadow-sm hover:shadow-md transition-shadow bg-white/80 backdrop-blur-sm border-queue-accent/20">
            ...
            <Card className="shadow-sm hover:shadow-md transition-shadow bg-white/80 backdrop-blur-sm border-queue-accent/20">
              <CardContent className="pt-6">
                <h2 className="text-2xl font-semibold mb-4 text-queue-secondary">Available Models</h2>
                <ul className="space-y-3">
                  <li className="flex items-start">
                    <div className="bg-queue-primary/10 text-queue-primary p-1 rounded mr-2">
                      <span className="font-mono font-medium">M/M/C</span>
                    </div>
                    <span className="text-gray-600">Markovian arrivals, Markovian service times, C servers</span>
                  </li>
                  <li className="flex items-start">
                    <div className="bg-queue-primary/10 text-queue-primary p-1 rounded mr-2">
                      <span className="font-mono font-medium">M/G/C</span>
                    </div>
                    <span className="text-gray-600">Markovian arrivals, General service time distribution, C servers</span>
                  </li>
                  <li className="flex items-start">
                    <div className="bg-queue-primary/10 text-queue-primary p-1 rounded mr-2">
                      <span className="font-mono font-medium">G/G/C</span>
                    </div>
                    <span className="text-gray-600">General arrival distribution, General service time distribution, C servers</span>
                  </li>
                </ul>
              </CardContent>
            </Card>
      ...
      <footer className="w-full py-6 px-4 text-center text-gray-500 text-sm">
